...
class Instalacao(models.Model):
    ...
    telefone1_cliente = models.CharField(max_length=10, blank=True, null=True, verbose_name='Telefone 1')
    telefone2_cliente = models.CharField(max_length=10, blank=True, null=True, verbose_name='Telefone 2')
