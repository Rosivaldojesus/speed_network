...
class Instalacao(models.Model):
    ...
    data_nascimento_cliente = models.DateField(auto_now_add=False, auto_now=False, blank=True, null=True,
    ...
    data_instalacao = models.DateField(auto_now_add=False, auto_now=False, blank=True, null=True,
                                       verbose_name='Data da Instalação')
    hora_instalacao = models.TimeField(auto_now_add=False, auto_now=False, blank=True, null=True,
                                       verbose_name='Hora da Instalação')
    ...
    data_finalizacao = models.DateField(auto_now_add=False, auto_now=False, blank=True, null=True,
    ...
    instalacao_criado_por = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='instalacao_criado_por',
                                              blank=True, null=True)
    instalacao_finalizado_por = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                                  related_name='instalacao_finalizado_por', blank=True, null=True)
...
class ClientesVoip(models.Model):
    ...
    funcionario_reserva_voip = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                                 related_name='funcionario_reserva_voip', blank=True, null=True)
